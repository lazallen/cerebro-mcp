/**
 * Type definitions for the Smart Meeting Scheduler (Feature 023)
 */
...
export interface MeetingDefinition {
  ...
  /** Email addresses of required attendees (other than the organiser) */
  attendees: string[];
...
export interface MeetingHistory {
   ...
   * - occurred:  the event has passed and was confirmed via calendarView
   * - skipped:   event was cancelled/not found, or no slot was available
   */
...
/** Expected cadence interval in days, keyed by MeetingFrequency */
export const CADENCE_DAYS: Record<MeetingFrequency, number> = {
  weekly: 7,
  fortnightly: 14,
  monthly: 30,
};
